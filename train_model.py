...
if __name__ == "__main__":
    # Замените example_json на данные, полученные из C# контроллера
    import sys
    json_input = sys.argv[1]  # Получение JSON данных из аргументов командной строки

    result = train_model(json_input)
    print(result)
